                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <select class="mws-select2 small" name="marriStat" id="marriStat">
                                ...
                                <option value="pos">Divorced</option>
                                <option value="pos">Other</option>
                            </select>
                        </div>
                    </div>
                    <div class="mws-form-row">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <select class="mws-select2 small" name="shomeDistrict" id="shomeDistrict">
                                <option value="dhk">Dhaka</option>
                                <option value="khl">Chittagong</option>
                                <option value="cit">Barisal</option>
                                <option value="ran">Khulna </option>
                                <option value="ran">Rangpur </option>
                                <option value="ran">Sylet</option>
                            </select>
                        </div>
                    </div>
                    <div class="mws-form-row">
